...
const BLOG = {
  ...
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.muzhuyu.cn/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '沐竹雨, 博客', // 网站关键词 英文逗号隔开
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || '/favicon.ico', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '陕ICP备15015216号-5', // 备案号 闽ICP备XXXXXX
  ...
  GREETING_WORDS:
    ...
    '曲江芙蓉外，酒肆朝天开,仲秋夜烹鱼，南湖听尘籁。,梵琴沐竹雨，桂香落章台。,叩弦又相问，何日君再来？',
